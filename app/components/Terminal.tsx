        ...
        <div className="flex gap-1">
          ...
          >
            <div className="mt-4 text-sm !text-black flex flex-col gap-2 justify-center text-center">
              ...
              <a
                className="bg-gradient-long bg-[length:600%] bg-left hover:bg-right duration-[5000ms] ease-linear text-white py-3 rounded-md text-lg flex gap-4 items-center justify-center cursor-pointer"
